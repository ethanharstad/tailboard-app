...
class AlgorithmState with _$AlgorithmState {
  ...
  const factory AlgorithmState.content({
    ...
    @JsonKey(toJson: historyToJson, fromJson: historyFromJson)
  ...
  factory AlgorithmState.fromJson(Map<String, dynamic> json) =>
      _$AlgorithmStateFromJson(json);
}

LinkedHashMap<DateTime, AlgorithmStep> historyFromJson(
...
Map<String, dynamic> historyToJson(
    LinkedHashMap<DateTime, AlgorithmStep> history) {
